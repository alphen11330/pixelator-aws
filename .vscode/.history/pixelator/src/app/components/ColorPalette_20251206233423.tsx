    ...
    <>
      ...
      >
        <button
          ...
          onClick={() => {
            // 💡 修正: sortPalette に 'brightness' (明度) を引数として渡す
            setColorPalette(sortPalette(colorPalette, "brightness"));
          }}
        >
          彩度
        </button>

        <button style={alignmenButtonStyle}>明度</button>
        <button style={alignmenButtonStyle}>色相</button>
      </div>
      {/* カラーパレットを配置 */}
