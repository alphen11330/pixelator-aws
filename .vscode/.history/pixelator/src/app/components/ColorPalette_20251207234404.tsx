...
const ColorPalette: React.FC<Props> = ({
  ...
  const handleApplyColor = () => {
    if (selectedColorIndex !== null) {
      handleColorChange(selectedColorIndex, tempColor);
    }
    closeModal();
  };
          ...
          <div style={modalContentStyle} onClick={(e) => e.stopPropagation()}>
            ...
            {!isEditing ? (
              <>
                ...
                <div>
                  <button style={modalButtonStyle} onClick={handleEditColor}>
              ...
              <>
                ...
                />
                <div>
                  <button style={modalButtonStyle} onClick={handleApplyColor}>
                    {isJP ? "適用" : "Apply"}
                  </button>
                  <button style={modalButtonStyle} onClick={closeModal}>
                    {isJP ? "キャンセル" : "Cancel"}
