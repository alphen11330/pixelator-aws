...
const DitherTypeDropdown: React.FC<Props> = ({
  ...
  const dithers = [
    ...
    { value: "bayerMatrixBasic", label: isJP ? "ベーシック" : "" }, //組織的ディザリング
    { value: "bayerMatrixNoise", label: isJP ? "ノイズ" : "" },
    { value: "bayerMatrixPlaid", label: isJP ? "チェック" : "" },
    { value: "bayerMatrixCheckered", label: isJP ? "市松模様" : "" },
    { value: "bayerMatrixLeadGlass", label: isJP ? "ガラス" : "" },
    { value: "bayerMatrixTile", label: isJP ? "タイル" : "" },
    { value: "bayerMatrixCRT_Vertical", label: isJP ? "たてじま" : "" },
    { value: "bayerMatrixCRT_Horizontal", label: isJP ? "よこじま" : "" },
    { value: "bayerMatrixDiagonal", label: isJP ? "斜めじま↘" : "" },
