...
const DitherTypeDropdown: React.FC<Props> = ({
  ...
  const dithers = [
    ...
    { value: "bayerMatrixPlaid", label: isJP ? "チェック" : "Plaid" },
    { value: "bayerMatrixCheckered", label: isJP ? "市松模様" : "Checkered" },
    ...
    { value: "bayerMatrixMeshLight", label: isJP ? "メッシュ１" : "Mesh1" },
    { value: "bayerMatrixMeshDark", label: isJP ? "メッシュ２" : "Mesh2" },
    {
      value: "bayerMatrixPolkadotLight",
      label: isJP ? "ハーフトーン１" : "Polkadot1",
    },
    {
      value: "bayerMatrixPolkadotDark",
      label: isJP ? "ハーフトーン２" : "Polkadot2",
    },
  ];
