...
const dithers = [
  ...
  { value: "bayerMatrixBasic" }, //組織的ディザリング
  { value: "bayerMatrixNoise" },
  { value: "bayerMatrixPlaid" },
  { value: "bayerMatrixCheckered" },
  { value: "bayerMatrixLeadGlass" },
  { value: "bayerMatrixTile" },
  { value: "bayerMatrixCRT_Vertical" },
  { value: "bayerMatrixCRT_Horizontal" },
  { value: "bayerMatrixDiagonal1" },
  { value: "bayerMatrixDiagonal2" },
  { value: "bayerMatrixMeshLight" },
  { value: "bayerMatrixMeshDark" },
  { value: "bayerMatrixPolkadotLight" },
  { value: "bayerMatrixPolkadotDark" },
];
const RandomButton: React.FC<Props> = ({
  ...
  const setRandomNatural = () => {
    setIsHue(false); //彩度オフ
    setColorCollection(false); //色調補正オフ
    setEdgeEnhancement(false); //輪郭線協調オフ
    setColorReduction(false); //減色オフ
    setContrast(false); //コントラストオフ
    setIsSaturation(false); //輝度オフ
