...
/**
 * ソートの軸を定義する型に 'lsh' (Luminance, Saturation, Hue) を追加
 */
export type SortAxis = 'saturation' | 'brightness' | 'hue' | 'lsh';
 ...
 * @param axis - ソートの基準となる軸 ('saturation', 'brightness', 'hue', 'lsh')
