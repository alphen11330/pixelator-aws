...
const Header = () => {
  ...
  const langButton: React.CSSProperties = {
    ...
    // 2. クリック時のイベントハンドラ
    const handleClick = () => {
        // 現在の画像パスに基づいて、新しいパスを決定します
        // この例では、単純に "/langEN.png" に変更するだけとしています。
        // トグル（交互に切り替える）処理を行う場合は、以下のようにします。
        
        // if (imageSrc === "/langJA.png") {
        //     setImageSrc("/langEN.png");
        // } else {
        //     setImageSrc("/langJA.png");
        // }

        // 要件通り、クリックしたら一度だけ "/langEN.png" に変更する場合:
        setImageSrc("/langEN.png");
